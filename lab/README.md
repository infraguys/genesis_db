...
*   Confirm synchronous replication settings in `synchronous_standby_names`.
...
*   Restart automation: `./automation_start.sh`
...
*   Find the problem if parameter didn't changed (don't forget about automation)
